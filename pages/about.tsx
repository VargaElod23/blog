            ...
            <div className="flex justify-center mb-8">
              <div className="flex space-x-4">
                <div className="w-48 h-48 bg-gray-200">
                  <Image
                    src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRHu76nbSHyFZlBywZ9REQRokcwX-oUR8Iv1g&usqp=CAU"
                    alt="Taraxa.io"
                    className="w-full h-full object-cover"
                    width={192}
                    height={192}
                ...
                <div className="w-48 h-48 bg-gray-200">
                  <Image
                    src="https://pbs.twimg.com/media/FbgJnITXgAAV19k.jpg"
                    alt="Autonomies.io"
                    className="w-full h-full object-cover"
                    width={192}
                    height={192}
                ...
                <div className="w-48 h-48 bg-gray-200">
                  <Image
                    src="https://res.cloudinary.com/crunchbase-production/image/upload/c_lpad,f_auto,q_auto:eco,dpr_1/ittch9eiagfhrz5jcfml"
                    alt="Lumara.com"
                    className="w-full h-full object-cover"
                    width={192}
                    height={192}
                ...
                <div className="w-48 h-48 bg-gray-200">
                  <Image
                    src="https://www.absl.ro/wp-content/uploads/2018/04/bosch-new-logo.jpg"
                    alt="Bosch.ro"
                    className="w-full h-full object-cover"
                    width={192}
                    height={192}
                ...
                <div className="w-48 h-48 bg-gray-200">
                  <Image
                    src="https://media.licdn.com/dms/image/C4E0BAQHAc9j2_SVbow/company-logo_200_200/0/1675753317670?e=2147483647&v=beta&t=N67TI13_CYCWDwVrMf2Oi6iDvHhtwMtjDYi2ixmCFec"
                    alt="Fortech.ro"
                    className="w-full h-full object-cover"
                    width={192}
                    height={192}
                ...
                <div className="w-48 h-48 bg-gray-200">
                  <Image
                    src="https://www.acjsfb.ro/wp-content/uploads/2019/10/2.-logo-WKR.jpg"
